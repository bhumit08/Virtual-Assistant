...
const Customize = () => {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px]'>
      ...
      {selectImage &&  <button type="submit" className="min-w-[150px] h-[60px] text-black mt-7 font-semibold bg-white rounded-full text-[19px]" onClick={()=>navigate("/customize2")}>Next</button>}
